...
const ContactUs = () => {
  const { loading } = use(AuthContext) as AuthContextType
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div data-aos="fade-right" data-aos-delay="100">
              <div className="rounded-xl  transition-all duration-500 ease-in-out hover:scale-110 hover:transform-[perspective(1000px)_rotateX(10deg)_rotateY(-10deg)_rotateZ(2deg)] hover:shadow-[-6px_6px_15px_rgba(0,0,0,0.25)] backface-hidden">
